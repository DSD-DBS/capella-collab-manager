...
async def test_git_models_are_resolved_correctly(
...
async def test_provision_session_with_compatible_tool_versions(
    db: orm.Session,
...
async def test_persistent_provisioning_too_many_models():
    raise NotImplementedError()


async def test_fallback_without_revision():
    raise NotImplementedError()
