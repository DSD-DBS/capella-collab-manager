...
KUBERNETES_STORAGE_CLASS_NAME = get_config("KUBERNETES", "STORAGE_CLASS_NAME", "persistent-sessions-csi")
KUBERNETES_STORAGE_ACCESS_MODE = get_config("KUBERNETES", "STORAGE_ACCESS_MODE", "ReadWriteMany")
