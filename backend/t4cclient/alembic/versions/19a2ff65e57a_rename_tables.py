...
def upgrade():
    ...
    op.alter_column("t4c_models", "repository_name", new_column_name="project_name")
    op.drop_constraint(
    ...
    op.create_foreign_key(
        None, "git_models", "projects", ["project_name"], ["name"], ondelete="CASCADE"
    )
    op.create_foreign_key(
...
def downgrade():
    ...
    op.alter_column("git_models", "project_name", new_column_name="repository_name")
