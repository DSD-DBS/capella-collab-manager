...
def upgrade():
    ...
    op.create_table('EASEBackup',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('gitmodel', sa.Integer(), nullable=True),
    sa.Column('t4cmodel', sa.Integer(), nullable=True),
    sa.Column('project', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['gitmodel'], ['git_models.id'], ),
    sa.ForeignKeyConstraint(['project'], ['repositories.name'], ),
    sa.ForeignKeyConstraint(['t4cmodel'], ['projects.id'], ),
