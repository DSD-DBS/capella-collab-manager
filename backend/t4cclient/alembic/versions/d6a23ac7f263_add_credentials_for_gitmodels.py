...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('git_models', sa.Column('project_id', sa.INTEGER(), autoincrement=False, nullable=True))
    op.create_foreign_key('git_models_project_id_fkey', 'git_models', 'projects', ['project_id'], ['id'], ondelete='CASCADE')
