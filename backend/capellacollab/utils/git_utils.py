...
def get_references(model_slug: str, url: str, username: t.Optional[str],
    password: t.Optional[str], token: JWTBearer=Depends(JWTBearer())
    ) -> GitRevisions:
    ...
    try:
        ...
        raise HTTPException(status_code=422,
            detail='Wrong credentials') from exc
    remote_refs.branches = [
        ref.name[7:] for ref in origin.refs]
