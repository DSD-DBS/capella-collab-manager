...
def get_users(
    ...
    Requires scope `admin.users/GET`.
    """
...
def create_user(
    ...
    Requires scope `admin.users/CREATE`.
    """
...
def get_common_projects(
    ...
    If you request with `admin.projects/GET` and `admin.users/GET` scopes,
...
def update_user(
    ...
    When changing the role to `ADMIN`, the explicit membership in all projects will be removed and
    will be replaced with an implicit membership in all projects.
...
def delete_user(
    ...
    Requires scope `admin.users/DELETE`.
    """
...
def get_user_events(
    ...
    Requires scopes `admin.users/GET` and `admin.events/GET`.
    """
    return user.events
