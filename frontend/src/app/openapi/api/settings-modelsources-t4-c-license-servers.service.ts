...
// @ts-ignore
import { PublicLicenseServerWithUsage } from '../model/public-license-server-with-usage';
// @ts-ignore
...
export class SettingsModelsourcesT4CLicenseServersService {
    ...
    /**
     * Get T4C License Servers Usage
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getT4cLicenseServersUsage(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<PublicLicenseServerWithUsage>>;
    public getT4cLicenseServersUsage(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<PublicLicenseServerWithUsage>>>;
    public getT4cLicenseServersUsage(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<PublicLicenseServerWithUsage>>>;
    public getT4cLicenseServersUsage(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/v1/settings/modelsources/t4c/license-servers/usage`;
        return this.httpClient.request<Array<PublicLicenseServerWithUsage>>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
