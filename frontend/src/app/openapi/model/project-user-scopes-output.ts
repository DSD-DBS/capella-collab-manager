...
export interface ProjectUserScopesOutput { 
    /**
     * Add capability to delete the project or update the project metadata (visibility & project type & archiving)
     */
    root: Array<ProjectUserScopesOutput.RootEnum>;
    /**
     * See pipelines, create new pipelines or delete existing pipelines
     */
    pipelines: Array<ProjectUserScopesOutput.PipelinesEnum>;
    /**
     * Allow access to see or trigger pipeline runs
     */
    pipeline_runs: Array<ProjectUserScopesOutput.PipelineRunsEnum>;
    /**
     * Fetch diagrams via the diagram cache API
     */
    diagram_cache: Array<ProjectUserScopesOutput.DiagramCacheEnum>;
    /**
     * See links to TeamForCapella repositories
     */
    t4c_model_links: Array<ProjectUserScopesOutput.T4cModelLinksEnum>;
    /**
     * Manage links to Git repositories
     */
    git_model_links: Array<ProjectUserScopesOutput.GitModelLinksEnum>;
    /**
     * Manage tool models (UPDATE = Update description, version, nature and order of tool model)
     */
    tool_models: Array<ProjectUserScopesOutput.ToolModelsEnum>;
    /**
     * Configure used tools in the project
     */
    used_tools: Array<ProjectUserScopesOutput.UsedToolsEnum>;
    /**
     * Manage project users UPDATE/CREATE can also be used to update roles / escalate own privileges. Use with caution!
     */
    project_users: Array<ProjectUserScopesOutput.ProjectUsersEnum>;
    /**
     * Access log of project users
     */
    access_log: Array<ProjectUserScopesOutput.AccessLogEnum>;
    /**
     * Access to provisioned and read-only sessions (includes access to the content of linked Git repositories)
     */
    provisioning: Array<ProjectUserScopesOutput.ProvisioningEnum>;
    /**
     * Access to TeamForCapella repositories in persistent sessions (Session token will created with GET access)
     */
    t4c_access: Array<ProjectUserScopesOutput.T4cAccessEnum>;
    /**
     * Manage restrictions on models (Provide access to pure::variants)
     */
    restrictions: Array<ProjectUserScopesOutput.RestrictionsEnum>;
    /**
     * Access to shared project volumes / workspaces. GET will provide read-only access, UPDATE will provide read & write access, CREATE will provide the ability to create a new shared volume, DELETE will provide the ability to delete shared volumes.
     */
