...
import { SessionToolConfigurationInput } from './session-tool-configuration-input';
import { ToolBackupConfigurationInput } from './tool-backup-configuration-input';


export interface ToolVersionConfigurationInput { 
    /**
     ...
     */
    sessions?: SessionToolConfigurationInput;
    /**
     * Configuration for the backup pipelines.
     */
    backups?: ToolBackupConfigurationInput;
    /**
