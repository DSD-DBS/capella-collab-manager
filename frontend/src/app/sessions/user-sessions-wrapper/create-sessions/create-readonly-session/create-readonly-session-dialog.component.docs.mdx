...
When different tool versions are compatible, this is displayed when creating a read-only sessions:

<Story of={CreateReadonlySessionDialog.ShowNoteForCompatibleSession}/>
